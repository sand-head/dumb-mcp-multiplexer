...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options), IDataProtectionKeyContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Profile>(entity =>
        {
            ...
            entity.Property(e => e.CodeModeEnabled).HasColumnName("code_mode_enabled").IsRequired().HasDefaultValue(false);
            entity.Property(e => e.CodeModeToonEnabled).HasColumnName("code_mode_toon_enabled").IsRequired().HasDefaultValue(false);
            entity.Property(e => e.CreatedAt).HasColumnName("created_at").IsRequired();
            entity.Property(e => e.UpdatedAt).HasColumnName("updated_at").IsRequired();
        ...
        modelBuilder.Entity<Skill>(entity =>
        {
            ...
            entity.Property(e => e.ArgumentsJson).HasColumnName("arguments_json").IsRequired().HasDefaultValue("[]");
